# 網路模擬與分析(4/19): Midterm Test 
###### tags: `Mininet`、`SDN`、`OpenFlow`、`OpenvSwitch`

期中考題目:

![](https://i.imgur.com/Oz5H71Z.png)

1. 用`ip route`規則去完成這樣的實驗 
...
* **若第一個實驗在 Mininet 環境中出錯，可以先嘗試用以下拓樸去完成實驗**

![](https://i.imgur.com/kiFIBfM.png)
